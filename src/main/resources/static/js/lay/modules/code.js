...
layui.define('jquery', function(exports){
  ...
  exports('static.pages.base.code', function(options){
    var elems = [];
    options = options || {};
    ...
    layui.each(elems.reverse(), function(index, item){
      ...
      if(!othis.find('>.layui-code-h3')[0]){
        othis.prepend('<h3 class="layui-code-h3">'+ (othis.attr('lay-title')||options.title||'static.pages.base.code') + (options.about ? '<a href="'+ about +'" target="_blank">layui.code</a>' : '') + '</h3>');
      }
